...
namespace Broccoli.TreeNodeEditor
{
	...
	public class WindEffectElementEditor : PipelineElementEditor {
		...
		private static GUIContent trunkBendingContent = new GUIContent ("Trunk Bending", "Deformity factor to apply wind directional bending to the main trunk.");
		#endregion
		...
		private static string MSG_RESET_WIND_TITLE = "Reset Wind";
		private static string MSG_RESET_WIND_MSG = "Do you really want to reset Wind values?";
		private static string MSG_RESET_WIND_OK = "Yes, Reset";
		private static string MSG_RESET_WIND_CANCEL = "Cancel";
		#endregion
		...
		protected override void OnInspectorGUISpecific () {
			...
			FloatRangePropertyField (propMinSprout1Sway, propMaxSprout1Sway, 0f, 0.6f, labelSprout1Sway);
			ShowHelpBox (MSG_SPROUT1_SWAY);
			FloatRangePropertyField (propMinSprout2Sway, propMaxSprout2Sway, 0f, 0.6f, labelSprout2Sway);
			...
			if (GUILayout.Button (resetWindBtn)) {
				if (EditorUtility.DisplayDialog (MSG_RESET_WIND_TITLE, MSG_RESET_WIND_MSG, MSG_RESET_WIND_OK, MSG_RESET_WIND_CANCEL)) {
					windEffectElement.minSprout1Sway = 0.2f;
					windEffectElement.maxSprout1Sway = 0.4f;
					windEffectElement.minSprout2Sway = 0.2f;
					windEffectElement.maxSprout2Sway = 0.4f;
					propBranchSway.floatValue = 0.5f;
					propBranchSwayFlexibility.floatValue = 0.4f;
					propTrunkBending.floatValue = 0.8f;
					changed = true;
				}
			}

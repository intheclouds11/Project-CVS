...
namespace Broccoli.Builder
{
    public class TextureBuilder {
        ...
        public Texture2D GetTexture (Plane cameraPlane, Vector3 cameraUp, string texturePath = "", bool allowMSAA = true) {
            return GetTexture (cameraPlane, cameraUp, _targetMesh.bounds, texturePath, allowMSAA);
        }
        public Texture2D GetTexture (Plane cameraPlane, Vector3 cameraUp, Bounds bounds, string texturePath = "", bool allowMSAA = true) {
            if (_targetGameObject == null) {
                ...
                RenderTextureDescriptor descriptor = new RenderTextureDescriptor((int)finalTextureSize.x, (int)finalTextureSize.y, RenderTextureFormat.ARGB32)
                {
                    depthBufferBits = 0,
        ...
        public Texture2D GetTexture (Vector3 cameraCenter, Vector3 cameraPlaneNormal, Vector3 cameraPlaneUp, Bounds cameraBounds, string texturePath = "", bool allowMSAA = true) {
            if (_targetGameObject == null) {
                Debug.LogWarning ("Target mesh not set on TextureBuilder.");
            } else {
                // Prepare target

...
namespace Broccoli.Component
{
	...
	public class StructureGeneratorComponent : TreeFactoryComponent, IStructureGeneratorComponent {
			...
			TreeFactoryProcessControl processControl = null) 
		{
			...
			generator.onBeforeGenerateStructures -= OnBeforeGenerateStructures;
			generator.onBeforeGenerateStructures += OnBeforeGenerateStructures;
		}
		/// <summary>
		/// Reset fixed seed in case randomization for structures is seeded. This guarantees structural continuity when levels are enabled/disabled.
		/// </summary>
		/// <param name="structures"></param>
		/// <param name="structureLevel"></param>
		/// <param name="parentStructure"></param>
		void OnBeforeGenerateStructures (List<StructureGenerator.Structure> structures, StructureGenerator.StructureLevel structureLevel, StructureGenerator.Structure parentStructure)
		{
			if (structureLevel.isSprout) {
				structureGeneratorElement.ResetFixedSeed ();
			}
		}
		/// <summary>

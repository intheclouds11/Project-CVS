		...
		public override bool Process (TreeFactory treeFactory, 
			...
			if (pipelineElement != null && tree != null) {
				...
				if (branchMeshGeneratorElement != null && branchMeshGeneratorElement.isActive) {
					...
					stWindMetaBuilder.minSprout1Sway = windEffectElement.minSprout1Sway;
					stWindMetaBuilder.maxSprout1Sway = windEffectElement.maxSprout1Sway;
					stWindMetaBuilder.minSprout2Sway = windEffectElement.minSprout2Sway;
					stWindMetaBuilder.maxSprout2Sway = windEffectElement.maxSprout2Sway;
					...
					stWindMetaBuilder.branchSwayExp = windEffectElement.branchSwayFlexibility;

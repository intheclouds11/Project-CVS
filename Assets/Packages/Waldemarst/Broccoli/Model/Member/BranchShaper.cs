...
namespace Broccoli.Model {
    ...
    public abstract class BranchShaper {
        #region Constants
        public const int DEFAULT_SHAPER = 0;
        public const int BULBOUS_SHAPER = 1;
        public const int GLOBULAR_SHAPER = 2;
        public const int CUSTOM_SHAPER = 3;
        #endregion
        ...
        /// <param name="branch">Branch instance.</param>
        /// <returns>Surface point on a branch.</returns>
        public virtual Vector3 GetSurfaceNormalAt (float position, float rollAngle, BroccoTree.Branch branch) {
            return GetNormalAt (position, rollAngle, branch);
        }
        /// <summary>

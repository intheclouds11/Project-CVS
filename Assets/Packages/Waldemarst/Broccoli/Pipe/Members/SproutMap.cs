...
namespace Broccoli.Pipe {
	...
	public class SproutMap {
		...
		/// <summary>
		/// Modes available to apply alpha variance to sprout meshes.
		/// </summary>
		public enum AlphaVarianceMode {
			None,
			Dissolve
		}
		/// <summary>
		/// Current variance mode to apply to sprout meshes.
		/// </summary>
		public AlphaVarianceMode alphaVarianceMode = AlphaVarianceMode.None;
		/// <summary>
		...
		/// <summary>
		/// Shade distribution mode.
		/// 	Uniform: randomly across the hierarchy.
		/// 	Hierarchy: distribution from the base to the top of the hierarchy.
		/// 	Branch: distribution from the base to the top of each branch.
		/// </summary>
		...
		/// Shade distribution mode.
		/// </summary>
		public ShadeMode shadeMode = ShadeMode.Uniform;
		/// <summary>
		/// The distributed values are switched.
		/// </summary>
		public bool invertShadeMode = false;
		/// <summary>
		/// Variance for Hierarchy and Branch distribution to be more randomly distributed.
		/// </summary>
		public float shadeVariance = 0f;
		/// <summary>
		/// Minimum value for dissolving. A value of 0 has no dissolving effect (alpha = 1).
		/// </summary>
		public float minColorDissolve = 0f;
		/// <summary>
		/// Max value for dissolving. A value of 0 has no dissolving effect (alpha = 1).
		/// </summary>
		public float maxColorDissolve = 0f;
		/// <summary>
		/// Dissolve distribution mode.
		/// 	Uniform: randomly across the hierarchy.
		/// 	Hierarchy: distribution from the base to the top of the hierarchy.
		/// 	Branch: distribution from the base to the top of each branch.
		/// </summary>
		...
		/// Dissolve distribution mode.
		/// </summary>
		public DissolveMode dissolveMode = DissolveMode.Uniform;
		/// <summary>
		/// The distributed values are switched.
		/// </summary>
		public bool invertDissolveMode = false;
		/// <summary>
		/// Variance for Hierarchy and Branch distribution to be more randomly distributed.
		/// </summary>
		public float dissolveVariance = 0f;
		/// <summary>
		/// Enable color tint.
		/// </summary>
		...
		public SproutMap Clone () {
			...
			clone.alphaVarianceMode = alphaVarianceMode;
			clone.minColorShade = minColorShade;
			clone.maxColorShade = maxColorShade;
			clone.shadeMode = shadeMode;
			clone.invertShadeMode = invertShadeMode;
			clone.shadeVariance = shadeVariance;
			clone.minColorDissolve = minColorDissolve;
			clone.maxColorDissolve = maxColorDissolve;
			clone.dissolveMode = dissolveMode;
			clone.invertDissolveMode = invertDissolveMode;
			clone.dissolveVariance = dissolveVariance;

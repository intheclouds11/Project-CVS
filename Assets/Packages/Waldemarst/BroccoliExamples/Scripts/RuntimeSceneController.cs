...
namespace Broccoli.Examples 
{
	...
	public class RuntimeSceneController : MonoBehaviour {
		...
		/// <summary>
		/// Clears all the tree instances on this scene controller.
		/// </summary>
		public void ClearInstances ()
		{
			while (spawnedTrees.Count > 0) {
				GameObject treeToDestroy = spawnedTrees.Dequeue ();
				float destroyTime = Random.Range (0.5f, 1.2f);
				StartCoroutine (ScaleTo (treeToDestroy, 0f, destroyTime, true));
			}
		}
		/// <summary>
